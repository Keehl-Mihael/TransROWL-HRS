...
file_in = open(files_src + 'relation2vec_250epoch.vec', 'r')
for line in file_in:
    x=line.split()
    sub_mat = []
    for val in x: 
...
file_in = open(files_src + 'A_250epoch.vec', 'r')
sub_mat = []
for line in file_in:
    x=line.split()
    for val in x: 
...
with open("/home/mihaelkeehl/Documenti/Tesi/MaterialeCodice/Creazioni/TransROWL - HRS/Test_acc/" +"result_lp_250epoch.txt", "a") as myfile:
